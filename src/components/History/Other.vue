...
const toolSkills = [
  ...
  { name: "Asana", icon: "icon-asana.svg" },
  { name: "Gemini", icon: "icon-gemini.svg" },
  { name: "ChatGPT", icon: "icon-chatgpt.svg" },
  { name: "Notepad++", icon: "icon-notepadplusplus.svg" },
];

const selectedItem = ref("Gemini"); // 센스 있게 Gemini를 기본값으로!
const select = (name) => {
