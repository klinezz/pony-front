      ...
      <table>
        ...
        <tbody>
          <tr>
            <td>인프라</td>
            <td>
              길디 긴 제목입니다. 하지만 너비를 넘어가면 줄바꿈되거나 잘립니다.
            </td>
            <td>관리자</td>
            <td>2026-02-10</td>
          </tr>
...
.active-border {
  animation: border-move 1.5s ease-out; /* 1.5초 동안만 실행 */
}
.category_item img {
  width: 37px;
  height: 37px;
